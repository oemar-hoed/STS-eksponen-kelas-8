...
const bankSoal = [
  ...
  },
  {
    id: 5,
    tipe: "pg_tunggal",
    pertanyaan: "Jika suatu segitiga siku-siku diketahui sisi siku-sikunya 8 cm dan 15 cm. Berapa panjang sisi miringnya?",
    opsi: ["13 cm", "17 cm", "23 cm", "27 cm"],
    jawabanBenar: 1 // Kunci: B
  },
  {
    id: 6,
  ...
  },
  {
    id: 14,
    tipe: "pg_kompleks",
    pertanyaan: "Perhatikan empat kelompok tiga bilangan berikut. Kelompok bilangan yang merupakan Tripel Pythagoras ditunjukkan oleh nomor ....",
    opsi: [
      { teks: "(1) 5, 12, 13", benar: true },
      { teks: "(2) 8, 15, 17", benar: true },
      { teks: "(3) 10, 20, 25", benar: false },
      { teks: "(4) 12, 16, 20", benar: true }
    ]
  },
  {
    id: 15,
  ...
  // ==========================================
  {
    id: 16,
    tipe: "uraian",
    pertanyaan: "Sederhanakan operasi penjumlahan dan pengurangan bentuk akar berikut: \\( 3\\sqrt{12} + 2\\sqrt{75} - \\sqrt{147} \\)"
  },
  {
    id: 17,
    tipe: "uraian",
